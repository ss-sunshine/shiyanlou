<template>
  <div>
    <div>
      <div class="itemArr p-r" v-for="(item,index) in itemArr" :key="index"  @mouseenter="mouseenter" @mouseleave="mouseleave">
        ...
        <div class="detail p-a-l" :class="{'none':flag=false,'block':flag=true}">
